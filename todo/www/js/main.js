...
demoApp.controller('MainController', function ($scope, $http, $cookies) {
    ...
    if ($cookies.user != null) {
        $http.get('https://secure-hamlet-95944.herokuapp.com/getListTask').then(function (resp) {
            var a = [];
            ...
            for (var i = 0; i < $scope.LesTaches.length; i++) {
                ...
                $http.post('https://secure-hamlet-95944.herokuapp.com/getTaskSet', req).then(function (resp) {
                    var value = [];
    ...
    $scope.createTodo = function (id, index) {
        if ($scope.name.text != null) {
            ...
            $http.post('https://secure-hamlet-95944.herokuapp.com/addTask', req)
    ...
    $scope.deleteTodo = function (id, index, listeid) {
        ...
        $http.post('https://secure-hamlet-95944.herokuapp.com/deleteTask', req)
            .success(function (data) {
                $scope.ListeTask.valeur[index] = data;
    ...
    $scope.updateToDo = function (id, index, listeid) {
        ...
        $http.post('https://secure-hamlet-95944.herokuapp.com/updateTask', $scope.updateData).success(function (data) {
    ...
    $scope.isSelect = function (id, done, index, listeid) {
        ...
        $scope.updateData.listeid = listeid;
        $http.post('https://secure-hamlet-95944.herokuapp.com/updateDone', $scope.updateData).success(function (data) {
    ...
    $scope.deleteList = function (id, index) {
        ...
        $http.post('https://secure-hamlet-95944.herokuapp.com/deleteList', req).success(function (data) {
            var a = [];
    ...
    $scope.createList = function () {
        if ($scope.list.text != null) {
            ...
            $http.post('https://secure-hamlet-95944.herokuapp.com/addList', req).success(function (data) {
                var a = [];
                for (var i = 0; i < data.length; i++) {
                    if (data[i].username == $cookies.user) {
                        a.push(data[i]);
...
connexionApp.controller('ConnexionController', function ($scope, $http, $cookies) {
    ...
    $scope.connexion = function () {
        ...
        $http.post('https://secure-hamlet-95944.herokuapp.com/connexion', req).then(function (resp) {
    ...
    $scope.inscription = function () {
        ...
        $http.post('https://secure-hamlet-95944.herokuapp.com/verif', req).then(function (resp) {
            if (resp.data.length == 0) {
